...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260621090848_AddEventDiscoveryIndexes")]
    partial class AddEventDiscoveryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.DomainEvents.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.DomainEvents.ProcessedMessage", b =>
                {
            ...
            modelBuilder.Entity("Domain.Subscriptions.UserSubscription", b =>
                {
                    b.HasOne("Domain.Events.EventCategory", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict);
